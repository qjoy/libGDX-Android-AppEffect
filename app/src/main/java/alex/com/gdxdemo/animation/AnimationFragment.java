...
public class AnimationFragment extends AndroidFragmentApplication implements InputProcessor {
	...
	//粒子效果绘制层
	private AnimationEffectView m_animationEffectView;
	//Fragment 处于销毁过程中标志位
	...
	public void preDestory() {
		m_isDestorying = true;
		m_animationEffectView.setCanDraw(false);
	}
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		m_viewRooter = inflater.inflate(R.layout.lf_layout_animation, null);
	...
	public void cleanGDX() {
		try {
			m_animationEffectView.dispose();
		}catch (Exception e){}
		mContainer.removeAllViews();
		m_animationEffectView = null;
	}

	public void buildGDX() {
		m_animationEffectView = new AnimationEffectView(getActivity());
		View effectview = CreateGLAlpha(m_animationEffectView);
	...
	public void onStart() {
		...
		m_animationEffectView.setCanDraw(true);
		super.onStart();
